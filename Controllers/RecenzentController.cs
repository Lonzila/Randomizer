...
namespace Randomizer.Controllers
{
    public class RecenzentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RecenzentID,Sifra,Ime,Priimek,EPosta,SteviloProjektov,Drzava")] Recenzent recenzent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RecenzentID,Sifra,Ime,Priimek,EPosta,SteviloProjektov,Drzava")] Recenzent recenzent)
        {
